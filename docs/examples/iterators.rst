...
just so happen to be using github4.py to do this. You might write code that
looks like this:
...
.. code-block:: python
    ...
    g = github4.login(USERNAME, PASSWORD)
...
avoid this with :class:`GitHubIterator <github4.structs.GitHubIterator>`.

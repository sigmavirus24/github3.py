...
Using Logging with github4.py
=============================

.. versionadded:: 0.6.0

The following example shows how to set up logging for github4.py. It is off by
...
* Construction of URLs used in requests, usually in the form:
  ``('https://api.github.com', 'repos', 'staticdev', 'github4.py')``

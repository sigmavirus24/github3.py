...
Let's say you're designing an application that uses github4.py. If your
...
is only so much someone can do with it and it works well with github4.py.

Requesting a token
~~~~~~~~~~~~~~~~~~

If you're not doing a web application, you are more than welcome to use
github4.py (otherwise work with redirects_). Let's say your application needs

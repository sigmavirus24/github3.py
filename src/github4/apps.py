...
APP_PREVIEW_HEADERS = {"Accept": "application/vnd.github.machine-man-preview+json"}
...
class App(models.GitHubCore):
    """An object representing a GitHub App.
        ...
        .. attribute:: owner
            ...
            A :class:`~github4.users.ShortUser` object representing the GitHub
...
def create_jwt_headers(private_key_pem, app_id, expire_in=DEFAULT_JWT_TOKEN_EXPIRATION):
    """Create an encrypted token for the specified App.

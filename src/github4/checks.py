...
class CheckPullRequest(models.GitHubCore):
    ...
    .. note::
        ...
        Refreshing this object returns a :class:`~github4.pulls.PullRequest`.
...
class CheckApp(models.GitHubCore):
    ...
    .. note::
        ...
        Refreshing this object returns a :class:`~github4.apps.App`.
    ...
    CUSTOM_HEADERS = {"Accept": "application/vnd.github.machine-man-preview+json"}
    ...
    def _repr(self):
        return '<App ["{}" by {}]>'.format(self.name, str(self.owner["login"]))
...
class CheckSuite(models.GitHubCore):
    ...
    .. attribute:: original_pull_requests
        ...
        :class:`~github4.checks.CheckPullRequest`.
    ...
    .. attribute:: app
        ...
        A :class:`~github4.checks.CheckApp` representing the App
...
class CheckRunOutput(models.GitHubCore):
    ...
    def annotations(self):
        ...
        :rtype:
            :class:`~github4.checks.CheckRunAnnotations`
        """
...
class CheckRun(models.GitHubCore):
    ...
    .. attribute:: output
        ...
        A :class:`~github4.checks.CheckRunOutput` representing the output
        of this check run.

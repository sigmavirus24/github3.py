...
class EventUser(models.GitHubCore):
    ...
    .. note::
        ...
        Refreshing this object will return a :class:`~github4.users.User`.
...
class EventReviewComment(models.GitHubCore):
    ...
    .. note::
        ...
        :class`~github4.pulls.ReviewComment`
    ...
    .. attribute:: user
        ...
        A :class:`~github4.users.ShortUser` representing the user who authored
        this comment.
    """
...
class Event(models.GitHubCore):
    ...
    .. attribute:: actor
        ...
        A :class:`~github4.events.EventUser` that represents the user whose
    ...
    .. attribute:: org
        ...
        If present, a :class:`~github4.events.EventOrganization` representing
...
def _pullreqev(payload, session):
    if payload.get("pull_request"):
        payload["pull_request"] = EventPullRequest(payload["pull_request"], session)
    return payload

# -*- coding: utf-8 -*-
"""All exceptions for the github4 library."""
...
class GitHubError(GitHubException):
    ...
    .. versionchanged:: 1.0.0
        ...
        This now inherits from :class:`~github4.exceptions.GitHubException`
...
class IncompleteResponse(GitHubError):
    ...
    This has the same attributes as :class:`~github4.exceptions.GitHubError`
    as well as
...
class TransportError(GitHubException):
    ...
    .. versionchanged:: 1.0.0
        ...
        Now inherits from :class:`~github4.exceptions.GitHubException`.
    """

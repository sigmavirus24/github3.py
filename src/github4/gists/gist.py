...
class _Gist(models.GitHubCore):
    ...
    def create_comment(self, body):
        ...
        :rtype:
            :class:`~github4.gists.comment.GistComment`
        """
        json = None
        if body:
    ...
    def commits(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.gists.history.GistHistory`
        """
...
class Gist(_Gist):
    ...
    :meth:`~github4.github.GitHub.gist`. To provide a clear distinction
    between the types of gists, github4.py uses different classes with
    different sets of attributes.

    This object has all the same attributes as
    :class:`~github4.gists.gist.ShortGist` as well as:
    ...
    .. attribute:: original_forks
        ...
        A list of :class:`~github4.gists.gist.GistFork` objects representing
    ...
    .. attribute:: history
        ...
        A list of :class:`~github4.gists.history.GistHistory` objects
...
class ShortGist(_Gist):
    ...
    represent the full amount of information returned for a specific
    gist. For example, you would receive this class when calling
    :meth:`~github4.github.GitHub.all_gists`. To provide a clear distinction
    between the types of gists, github4.py uses different classes with
    different sets of attributes.
    ...
    .. attribute:: html_url
        ...
        ``https://gist.github.com/staticdev/6faaaeb956dec3f51a9bd630a3490291``
    ...
    .. attribute:: git_pull_url
        ...
        ``git://gist.github.com/staticdev/6faaaeb956dec3f51a9bd630a3490291.git``
    ...
    .. attribute:: owner
        ...
        This attribute is a :class:`~github4.users.ShortUser` object
        representing the creator of the gist.

    .. attribute:: files

        A dictionary mapping the filename to a
        :class:`~github4.gists.gist.GistFile` object.

...
class GistHistory(models.GitHubCore):
    ...
    .. attribute:: user
        ...
        The :class:`~github4.users.ShortUser` representation of the user who
        owns this gist.
    ...
    For convenience, github4.py also exposes the following attributes from the
    :attr:`change_status`:
    ...
    def gist(self):
        ...
        :rtype:
            :class:`Gist <github4.gists.gist.Gist>`
        """

...
class Blob(models.GitHubCore):
    ...
    def decode_content(self):
        ...
        if self.encoding == "base64" and self.content:
            return base64.b64decode(self.content.encode("utf-8")).decode("utf-8")
        return self.content
...
class Commit(_Commit):
    ...
    This is distinct from :class:`~github4.repos.commit.RepoCommit`.
    ...
    :class:`~github4.git.ShortCommit` as well as the following attributes:
...
class ShortCommit(_Commit):
    ...
    :class:`~github4.repos.commit.RepoCommit` to represent the git data
    associated with it.
...
class Reference(models.GitHubCore):
    ...
    .. attribute:: object
        ...
        A :class:`~github4.git.GitObject` that this reference points to.
...
class Tag(models.GitHubCore):
    ...
    .. attribute:: object
        ...
        A :class:`~github4.git.GitObject` that represents the underlying git
        object.
...
class CommitTree(models.GitHubCore):
    ...
    representing a :class:`~github4.git.ShortCommit` or
    :class:`~github4.git.Commit`, the API returns an abbreviated
...
class Tree(models.GitHubCore):
    ...
    .. attribute:: tree
        ...
        it will have instances of :class:`~github4.git.Hash`.
    """

...
_pubsub_re = re.compile(r"https?://[\w\d\-\.\:]+/\w[\w-]+\w/[\w\._-]+/events/\w+")
...
class GitHub(models.GitHubCore):
    ...
    def activate_membership(self, organization):
        ...
        :type organization:
            str
        :type organization:
            :class:`~github4.orgs.Organization`
        :returns:
            the activated membership
        :rtype:
            :class:`~github4.orgs.Membership`
        """
    ...
    def all_organizations(self, number=-1, since=None, etag=None, per_page=None):
        ...
        :rtype:
            :class:`~github4.orgs.ShortOrganization`
        """
    ...
    def app(self, app_slug):
        ...
        :param app_slug:
            ...
            ``test-github4-py-apps``.
        :returns:
            The app if and only if it is public.
        :rtype:
            :class:`~github4.apps.App`
    ...
    def app_installation(self, installation_id):
        ...
        :returns:
            The installation.
        :rtype:
            :class:`~github4.apps.Installation`
        ...
        json = self._json(self._get(url, headers=apps.APP_PREVIEW_HEADERS), 200)
    ...
    def authenticated_app(self):
        ...
        """
        headers = apps.APP_PREVIEW_HEADERS
        json = self._json(self._get(self._build_url("app"), headers=headers), 200)
        return self._instance_or_null(apps.App, json)
    ...
    def authorization(self, id_num):
        ...
        :returns:
            :class:`~github4.auths.Authorization`
        """
        json = None
        if int(id_num) > 0:
    ...
    def create_issue(
        ...
        .. warning::
            ...
            :py:meth:`repository <github4.github.GitHub.repository>` and then
            use :py:meth:`create_issue
            <github4.repos.repo.Repository.create_issue>`
        ...
        :param int milestone:
            ...
            (e.g. if ``m`` is a :class:`~github4.issues.Milestone` object,
    ...
    def issue(self, username, repository, number):
        ...
        if username and repository and int(number) > 0:
            url = self._build_url("repos", username, repository, "issues", str(number))
            json = self._json(self._get(url), 200)
    ...
    def issues(
        ...
        params = issues.issue_params(filter, state, labels, sort, direction, since)
    ...
    def license(self, name):
        ...
        :rtype:
            :class:`~github4.licenses.License`
        """
    ...
    def licenses(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.licenses.ShortLicense`
        """
    ...
    def me(self):
        ...
        :rtype:
            :class:`~github4.users.AuthenticatedUser`
        """
    ...
    def notifications(self, all=False, participating=False, number=-1, etag=None):
        ...
        return self._iter(int(number), url, notifications.Thread, params, etag=etag)
    ...
    def project_card(self, number):
        ...
        :returns:
            :class:`~github4.projects.ProjectCard`
        """
        number = int(number)
        json = None
        if number > 0:
    ...
    def project_column(self, number):
        ...
        :returns:
            :class:`~github4.projects.ProjectColumn`
        """
        number = int(number)
        json = None
        if number > 0:
    ...
    def public_gists(self, number=-1, etag=None, since=None):
        ...
        :returns:
            generator of short gists
        :rtype:
            :class:`~github4.gists.gist.ShortGist`
        """
        params = None
        url = self._build_url("gists", "public")
        if since is not None:
            params = {"since": utils.timestamp_parameter(since)}
        return self._iter(int(number), url, gists.ShortGist, params=params, etag=etag)
    ...
    def organization_memberships(self, state=None, number=-1, etag=None):
        ...
        return self._iter(int(number), url, orgs.Membership, params=params, etag=etag)
    ...
    def pull_request(self, owner, repository, number):
        ...
        json = None
        if int(number) > 0:
            url = self._build_url("repos", owner, repository, "pulls", str(number))
            json = self._json(self._get(url), 200)
    ...
    def repositories(self, type=None, sort=None, direction=None, number=-1, etag=None):
        ...
        return self._iter(int(number), url, repo.ShortRepository, params, etag)
    ...
    def revoke_authorization(self, access_token):
        ...
        url = self._build_url("applications", str(client_id), "tokens", access_token)
    ...
    def search_code(
        ...
        :rtype:
            :class:`~github4.search.code.CodeSearchResult`
        """
        params = {"q": query}
        headers = {}
    ...
    def search_commits(
        ...
        :rtype:
            :class:`~github4.search.commits.CommitSearchResult`
        """
        params = {"q": query}
    ...
    def search_issues(
        ...
        :rtype:
            :class:`~github4.search.issue.IssueSearchResult`
        """
        params = {"q": query}
        headers = {}
    ...
    def search_repositories(
        ...
        :rtype:
            :class:`~github4.search.repository.RepositorySearchResult`
        """
        params = {"q": query}
        headers = {}
    ...
    def search_users(
        ...
        :rtype:
            :class:`~github4.search.user.UserSearchResult`
        """
        params = {"q": query}
        headers = {}
    ...
    def set_user_agent(self, user_agent):
        ...
        :param str user_agent:
            ...
            Library default: "github4.py/{version}", e.g., "github4.py/1.0.0"
        """
        if not user_agent:
            return
...
class GitHubEnterprise(GitHub):
    ...
    def create_user(self, login, email):
        ...
        :returns:
            created user
        :rtype:
            :class:`ShortUser <github4.users.ShortUser>`
        """

...
class _Issue(models.GitHubCore):
    ...
    def _repr(self):
        return "<{class_name} [#{n}]>".format(n=self.number, class_name=self.class_name)

    @requires_auth
    def add_assignees(self, users):
        """Assign ``users`` to this issue.

        This is a shortcut for :meth:`~github4.issues.issue.Issue.edit`.

        :param users:
            users or usernames to assign this issue to
        :type users:
            list of :class:`~github4.users.User`
        :type users:
            list of str
        :returns:
    ...
    def add_labels(self, *args):
        ...
        :returns:
            list of labels
        :rtype:
            :class:`~github4.issues.label.ShortLabel`
        """
    ...
    def close(self):
        ...
        return self.edit(self.title, self.body, assignee, "closed", number, labels)
    ...
    def comment(self, id_num):
        ...
        :rtype:
            :class:`~github4.issues.comment.IssueComment`
        """
        json = None
    ...
    def edit(
        ...
        :param int milestone:
            ...
            .. note::
                ...
                value in :attr:`~github4.issues.milestone.Milestone.number`.
        :param list labels:
    ...
    def reopen(self):
        ...
        return self.edit(self.title, self.body, assignee, "open", number, labels)
...
class Issue(_Issue):
    ...
    :meth:`~github4.github.GitHub.issue`. To provide a clear
    distinction between the types of issues, github4.py uses different classes
    with different sets of attributes.

    .. versionchanged:: 1.0.0

    This object has all of the same attributes as a
    :class:`~github4.issues.issue.ShortIssue` as well as the following:
    ...
    .. attribute:: closed_by
        ...
        If the issue is closed, a :class:`~github4.users.ShortUser`
...
class ShortIssue(_Issue):
    ...
    .. attribute:: assignees
        ...
        a list of :class:`~github4.users.ShortUser`.
    ...
    .. attribute:: milestone
        ...
        A :class:`~github4.issues.milestone.Milestone` object representing the
    ...
    .. attribute:: original_labels
        ...
        :class:`~github4.issues.label.ShortLabel` objects representing the
    ...
    .. attribute:: user
        ...
        A :class:`~github4.users.ShortUser` representing the user who opened
        this issue.
    """

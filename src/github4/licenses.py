...
class RepositoryLicense(models.GitHubCore):
    ...
    :meth:`~github4.repos.repo.Repository.license` and behaves like
    :class:`~github4.repos.contents.Contents` with a few differences.
    ...
    .. attribute:: type
        ...
        Analogous to :attr:`github4.repos.contents.Contents.type`, this should
    ...
    .. attribute:: license
        ...
        A :class:`github4.licenses.ShortLicense` instance representing the

# -*- coding: utf-8 -*-
"""This module provides the basic models used in github4.py."""
...
class GitHubCore(object):
    ...
    def _repr(self):
        return "<github4-core at 0x{0:x}>".format(id(self))
    ...
    def _iter(
        ...
        :rtype: :class:`GitHubIterator <github4.structs.GitHubIterator>`
        """
        from .structs import GitHubIterator

        return GitHubIterator(count, url, cls, self, params, etag, headers, list_key)
    ...
    def new_session(self):
        ...
        :returns:
            A brand new session
        :rtype:
            :class:`~github4.session.GitHubSession`
        """

...
class PullDestination(models.GitHubCore):
    ...
    This is the base class for the :class:`~github4.pulls.Head` and
    :class:`~github4.pulls.Base` objects. Each has identical attributes to
    this object.
    ...
    .. attribute:: user
        ...
        If provided, a :class:`~github4.users.ShortUser` instance representing
    ...
    .. attribute:: repo
        ...
        ('sigmavirus24', 'github4.py')

        This attribute is generated by github4.py and may be deprecated in the
        future.
    """
...
class Head(PullDestination):
    ...
    See :class:`~github4.pulls.PullDestination` for more details.
    """
...
class _PullRequest(models.GitHubCore):
    ...
    def _update_attributes(self, pull):
        ...
        self.requested_teams = [orgs.ShortTeam(t, self) for t in requested_teams]
    ...
    def create_review_requests(self, reviewers=None, team_reviewers=None):
        ...
        if team_reviewers is not None:
            data["team_reviewers"] = [getattr(t, "slug", t) for t in team_reviewers]
        json = self._json(self._post(url, data=data), 201)
    ...
    def create_review(self, body, commit_id=None, event=None, comments=None):
        ...
        .. warning::
            ...
            :meth:`~github4.pulls.PullReview.submit`.)
        ...
        :returns:
            The created review.
        :rtype:
            :class:`~github4.pulls.PullReview`
        """
        if comments is None:
            comments = []
    ...
    def commits(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.repos.commit.ShortCommit`
        """
    ...
    def review_requests(self):
        ...
        :rtype:
            :class:`~github4.pulls.ReviewRequests`
        """
        url = self._build_url("requested_reviewers", base_url=self._api)
...
class PullRequest(_PullRequest):
    ...
    :meth:`~github4.github.GitHub.pull_request`. To provide a clear
    distinction between the types of prs, github4.py uses different classes
    with different sets of attributes.

    .. versionchanged:: 1.0.0

    This object has all of the same attributes as
    :class:`~github4.pulls.ShortPullRequest` as well as the following:
    ...
    .. attribute:: merged_by
        ...
        An instance of :class:`~github4.users.ShortUser` to indicate the user
...
class ShortPullRequest(_PullRequest):
    ...
    distinction between the types of Pull Requests, github4.py uses different
    ...
    .. attribute:: assignee
        ...
        instance of :class:`~github4.users.ShortUser`
    ...
    .. attribute:: assignees
        ...
        of instances of :class:`~github4.users.ShortUser`.

    .. attribute:: base

        A :class:`~github4.pulls.Base` object representing the base pull
        request destination.
    ...
    .. attribute:: head
        ...
        A :class:`~github4.pulls.Head` object representing the head pull
        request destination.
    ...
    .. attribute:: repository
        ...
        A :class:`~github4.repos.repo.ShortRepository` from the :attr:`base`
        instance.

    .. attribute:: requested_reviewers

        A list of :class:`~github4.users.ShortUser` from which a review was
        requested.

    .. attribute:: requested_teams

       A list of :class:`~github4.orgs.ShortTeam` from which a review was
       requested.
    ...
    .. attribute:: user
        ...
        A :class:`~github4.users.ShortUser` instance representing who opened
        this pull request.
    """
...
class PullReview(models.GitHubCore):
    ...
    .. attribute:: user
        ...
        A :class:`~github4.users.ShortUser` instance representing the author
        of this review.
    """

...
class _Branch(models.GitHubCore):
    ...
    def protection(self):
        ...
        :rtype:
            :class:`~github4.repos.branch.BranchProtection`
        """
...
class Branch(_Branch):
    ...
    calling :meth:`~github4.repos.repo.Repository.branches`. To provide a
    clear distinction between the types of branches, github4.py uses different
    classes with different sets of attributes.

    This object has the same attributes as a
    :class:`~github4.repos.branch.ShortBranch` as well as the following:
...
class ShortBranch(_Branch):
    ...
    .. attribute:: commit
        ...
        A :class:`~github4.repos.commit.MiniCommit` representation of the
...
class BranchProtection(models.GitHubCore):
    ...
    .. attribute:: enforce_admins
        ...
        A :class:`~github4.repos.branch.ProtectionEnforceAdmins` instance
        representing whether required status checks are required for admins.

    .. attribute:: restrictions

        A :class:`~github4.repos.branch.ProtectionRestrictions` representing
    ...
    .. attribute:: required_pull_request_reviews
        ...
        A :class:`~github4.repos.branch.ProtectionRequiredPullRequestReviews`
        representing the protection provided by requiring pull request
        reviews.

    .. attribute:: required_status_checks

        A :class:`~github4.repos.branch.ProtectionRequiredStatusChecks`
    ...
    PREVIEW_HEADERS_MAP = {
        ...
        "nested_teams": {"Accept": "application/vnd.github.hellcat-preview+json"},
    }
    ...
    def _update_attributes(self, protection):
        ...
        _set_conditional_attr("required_status_checks", ProtectionRequiredStatusChecks)
    ...
    def update(
        ...
        current_status = {
            ...
            "restrictions": (
                self.restrictions.as_dict() if self.restrictions is not None else None
            ),
        }
        edit = {
            "enabled": True,
        ...
        preview_key = "required_approving_review_count"
        headers = BranchProtection.PREVIEW_HEADERS_MAP[preview_key]
        json = self._json(self._put(self._api, json=edit, headers=headers), 200)
        self._update_attributes(json)
        return self
...
class ProtectionRestrictions(models.GitHubCore):
    ...
    .. attribute:: original_teams
        ...
        List of :class:`~github4.orgs.ShortTeam` objects representing
        the teams allowed to push to the protected branch.

    .. attribute:: original_users

        List of :class:`~github4.users.ShortUser` objects representing
...
class ProtectionRequiredPullRequestReviews(models.GitHubCore):
    ...
    .. attribute:: dismissal_restrictions
        ...
        If specified, a :class:`~github4.repos.branch.ProtectionRestrictions`
    ...
    def update(
        ...
        :rtype:
            :class:`~github4.repos.branch.ProtectionRequiredPullRequestReviews`
        """
        existing_values = {
            ...
            "dismissal_restrictions": {
                "users": [
                    getattr(u, "login", u)
                    for u in getattr(self.dismissal_restrictions, "original_users", [])
                ],
                "teams": [
                    getattr(t, "slug", t)
                    for t in getattr(self.dismissal_restrictions, "original_teams", [])
                ],
            },
...
class ProtectionRequiredStatusChecks(models.GitHubCore):
    ...
    def update(self, strict=None, contexts=None):
        ...
        :rtype:
            :class:`~github4.repos.branch.ProtectionRequiredStatusChecks`

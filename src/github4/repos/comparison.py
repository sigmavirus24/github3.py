...
class Comparison(models.GitHubCore):
    ...
    .. attribute:: base_commit
        ...
        A :class:`~github4.repos.commit.ShortCommit` representing the base
    ...
    .. attribute:: commits
        ...
        A list of :class:`~github4.repos.commit.ShortCommit` objects
    ...
    def _update_attributes(self, compare):
        ...
        if self.commits:
            self.commits = [commit.ShortCommit(com, self) for com in self.commits]

...
class Contents(models.GitHubCore):
    ...
    def delete(self, message, branch=None, committer=None, author=None):
        ...
        :rtype:
            :class:`~github4.repos.contents.Contents` and
        ...
        if message:
            ...
            if json and "content" in json:
                json["content"] = self._instance_or_null(Contents, json["content"])
        return json
    ...
    def update(self, message, content, branch=None, committer=None, author=None):
        ...
        :rtype:
            dictionary of :class:`~github4.repos.contents.Contents` and
            :class:`~github4.git.Commit`
        """

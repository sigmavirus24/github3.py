...
class Invitation(models.GitHubCore):
    ...
    .. attribute:: invitee
        ...
        A :class:`~github4.users.ShortUser` representing the user who was
    ...
    .. attribute:: repository
        ...
        A :class:`~github4.repos.ShortRepository` representing the repository
    ...
    def delete(self):
        ...
        :rtype:
            bool
        """
        url = self._build_url("invitations", self.id, base_url=self.repository.url)

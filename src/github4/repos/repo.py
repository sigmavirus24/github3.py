...
class _Repository(models.GitHubCore):
    ...
    def add_collaborator(self, username):
        ...
        :type username:
            str or :class:`~github4.users.User`
        :returns:
    ...
    def asset(self, id):
        ...
        :returns:
            the asset
        :rtype:
            :class:`~github4.repos.release.Asset`
        """
        data = None
        if int(id) > 0:
    ...
    def branch(self, name):
        ...
        :returns:
            the branch
        :rtype:
            :class:`~github4.repos.branch.Branch`
        """
        json = None
        if name:
    ...
    def check_suite(self, id):
        ...
        :returns:
            the check suite
        :rtype:
            :class:`~github4.checks.CheckSuite`
        """
        data = None
        if int(id) > 0:
    ...
    def collaborators(self, affiliation="all", number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.users.Collaborator`
        """
        ...
        return self._iter(int(number), url, users.Collaborator, params, etag=etag)
    ...
    def comments(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.repos.comment.RepoComment`
        """
    ...
    def commit(self, sha):
        ...
        :returns:
            the commit
        :rtype:
            :class:`~github4.repos.commit.RepoCommit`
        """
    ...
    def compare_commits(self, base, head):
        ...
        :rtype:
            :class:`~github4.repos.comparison.Comparison`
        """
        url = self._build_url("compare", base + "..." + head, base_url=self._api)
        json = self._json(self._get(url), 200)
    ...
    def contributor_statistics(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.repos.stats.ContributorStats`
        """
    ...
    def contributors(self, anon=False, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.users.Contributor`
        """
    ...
    def views(self, per="day"):
        ...
        :returns:
            views data
        :rtype:
            :class:`~github4.repos.traffic.ViewsStats`
        :raises:
    ...
    def clones(self, per="day"):
        ...
        :returns:
            clones data
        :rtype:
            :class:`~github4.repos.traffic.ClonesStats`
        :raises:
            ValueError if per is not a valid choice
        """
        params = {}
    ...
    def create_check_run(
        ...
        if name and head_sha:
            ...
            json = self._json(
                self._post(url, headers=checks.CheckRun.CUSTOM_HEADERS, data=data),
                201,
            )
    ...
    def create_check_suite(self, head_sha):
        ...
        if head_sha:
            ...
            json = self._json(
                self._post(url, data=data, headers=checks.CheckSuite.CUSTOM_HEADERS),
                201,
            )
    ...
    def create_branch_ref(self, name, sha=None):
        ...
        :meth:`github4.repos.repo.Repository.create_ref`.
    ...
    def create_deployment(
        ...
        :rtype:
            :class:`~github4.repos.deployment.Deployment`
        """
        json = None
        if ref:
    ...
    def create_file(
        ...
        :rtype:
            :class:`~github4.repos.contents.Contents`,
            :class:`~github4.git.Commit`
        """
    ...
    def create_fork(self, organization=None):
        ...
        :rtype:
            :class:`~github4.repos.repo.Repository`
        """
    ...
    def create_issue(
        ...
        :param int milestone:
            ...
            :class:`~github4.issues.milestone.Milestone` object, ``m.number``
        ...
        :returns:
            the created issue
        :rtype:
            :class:`~github4.issues.issue.ShortIssue`
        """
        issue = {
            "title": title,
            "body": body,
    ...
    def create_label(self, name, color, description=None):
        ...
        :returns:
            the created label
        :rtype:
            :class:`~github4.issues.label.Label`
        """
        json = None
        if name and color:
    ...
    def create_milestone(self, title, state=None, description=None, due_on=None):
        ...
        :rtype:
            :class:`~github4.issues.milestone.Milestone`
        """
    ...
    def create_project(self, name, body=None):
        ...
        :returns:
            the created project
        :rtype:
            :class:`~github4.projects.Project`
        """
        ...
        if data:
            json = self._json(
                self._post(url, data=data, headers=projects.Project.CUSTOM_HEADERS),
                201,
            )
    ...
    def create_pull(self, title, base, head, body=None):
        ...
        :rtype:
            :class:`~github4.pulls.ShortPullRequest`
        """
    ...
    def create_release(
        ...
        :returns:
            the created release
        :rtype:
            :class:`~github4.repos.release.Release`
        """
        data = {
    ...
    def create_status(
        ...
        :returns:
            the created status
        :rtype:
            :class:`~github4.repos.status.Status`
        """
        json = None
        if sha and state:
            data = {
    ...
    def create_tag(self, tag, message, sha, obj_type, tagger, lightweight=False):
        ...
        :returns:
            ...
            :class:`~github4.git.Reference`, otherwise it will return a
            :class:`~github4.git.Tag`
        :rtype:
            :class:`~github4.git.Tag` or :class:`~github4.git.Reference`
        """
    ...
    def directory_contents(self, directory_path, ref=None, return_as=list):
        ...
        :param str path:
            (required), path to file, e.g.  github4/repos/repo.py
        :param str ref:
        ...
        :rtype:
            [(str, :class:`~github4.repos.contents.Contents`)]
        :raises github4.exceptions.UnprocessableResponseBody:
        ...
        if not (isinstance(json, list) and all(isinstance(j, dict) for j in json)):
        ...
        return return_as((j.get("name"), contents.Contents(j, self)) for j in json)
    ...
    def edit(
        ...
        json = None
        if edit:
            json = self._json(self._patch(self._api, data=jsonlib.dumps(edit)), 200)
    ...
    def auto_trigger_checks(self, app_id, enabled=True):
        ...
        :rtype:
            dict
        """
        url = self._build_url("check-suites", "preferences", base_url=self._api)
        ...
        json = self._json(
            self._patch(
                ...
                headers=headers,
                data=jsonlib.dumps(
                    {"auto_trigger_checks": [{"app_id": app_id, "setting": enabled}]}
                ),
            ),
            200,
    ...
    def forks(self, sort="", number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.repos.repo.ShortRepository`
        """
        url = self._build_url("forks", base_url=self._api)
        params = {}
    ...
    def ignore(self):
        ...
        :rtype:
            :class:~github4.notifications.RepositorySubscription`
        """
        url = self._build_url("subscription", base_url=self._api)
        json = self._json(self._put(url, data=jsonlib.dumps({"ignored": True})), 200)
        return self._instance_or_null(notifications.RepositorySubscription, json)
    ...
    def imported_issue(self, imported_issue_id):
        ...
        :returns:
            the imported issue
        :rtype:
            :class:`~github4.repos.issue_import.ImportedIssue`
        """
        url = self._build_url("import/issues", imported_issue_id, base_url=self._api)
        data = self._get(url, headers=issue_import.ImportedIssue.IMPORT_CUSTOM_HEADERS)
    ...
    def invitations(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.repos.invitation.Invitation`
        """
    ...
    def issue(self, number):
        ...
        :returns:
            the issue
        :rtype:
            :class:`~github4.issues.issue.Issue`
        """
        json = None
        if int(number) > 0:
    ...
    def issue_events(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.issues.event.IssueEvent`
        """
        url = self._build_url("issues", "events", base_url=self._api)
        return self._iter(int(number), url, ievent.RepositoryIssueEvent, etag=etag)
    ...
    def issues(
        ...
        :returns:
            generator of issues
        :rtype:
            :class:`~github4.issues.ShortIssue`
        """
        url = self._build_url("issues", base_url=self._api)
    ...
    def latest_pages_build(self):
        ...
        :rtype:
            :class:`~github4.repos.pages.PagesBuild`
        """
    ...
    def license(self):
        ...
        :returns:
            the license
        :rtype:
            :class:`~github4.licenses.RepositoryLicense`
        """
    ...
    def mark_notifications(self, last_read=""):
        ...
        return self._boolean(self._put(url, data=jsonlib.dumps(mark)), 205, 404)
    ...
    def milestones(self, state=None, sort=None, direction=None, number=-1, etag=None):
    ...
    def notifications(
        ...
        :rtype:
            :class:`~github4.notifications.Thread`
        """
        url = self._build_url("notifications", base_url=self._api)
        params = {
            "all": str(all).lower(),
        ...
        self._remove_none(params)
        return self._iter(int(number), url, notifications.Thread, params, etag)
    ...
    def pages(self):
        ...
        :rtype:
            :class:`~github4.repos.pages.PagesInfo`
        """
    ...
    def project(self, id, etag=None):
        ...
        json = self._json(self._get(url, headers=projects.Project.CUSTOM_HEADERS), 200)
        return self._instance_or_null(projects.Project, json)
    ...
    def pull_request(self, number):
        ...
        :returns:
            the pull request
        :rtype:
            :class:`~github4.pulls.PullRequest`
        """
        json = None
        if int(number) > 0:
    ...
    def pull_requests(
        ...
        self._remove_none(params)
        return self._iter(int(number), url, pulls.ShortPullRequest, params, etag)
    ...
    def readme(self):
        ...
        :rtype:
            :class:`Contents <github4.repos.contents.Contents>`
        """
    ...
    def release_from_tag(self, tag_name):
        ...
        :rtype:
            :class:`~github4.repos.release.Release`
        """
        url = self._build_url("releases", "tags", tag_name, base_url=self._api)
        json = self._json(self._get(url), 200)
        return self._instance_or_null(release.Release, json)
    ...
    def replace_topics(self, new_topics):
        ...
        :rtype:
            :class:`~github4.repos.topics.Topics`
        """
        url = self._build_url("topics", base_url=self._api)
        data = {"names": new_topics}
        json = self._json(
            self._put(url, data=jsonlib.dumps(data), headers=self.PREVIEW_HEADERS),
            200,
        )
    ...
    def subscribe(self):
        ...
        """
        url = self._build_url("subscription", base_url=self._api)
        json = self._json(self._put(url, data=jsonlib.dumps({"subscribed": True})), 200)
        return self._instance_or_null(notifications.RepositorySubscription, json)
    ...
    def tags(self, number=-1, etag=None):
        ...
        :rtype:
            :class:`~github4.repos.tag.RepoTag`
        """
    ...
    def unignore(self):
        ...
        """
        url = self._build_url("subscription", base_url=self._api)
        json = self._json(self._put(url, data=jsonlib.dumps({"ignored": False})), 200)
        return self._instance_or_null(notifications.RepositorySubscription, json)
    ...
    def weekly_commit_count(self):
        ...
        .. note::
            ...
            All statistics methods may return a 202. If github4.py
...
class Repository(_Repository):
    ...
    :meth:`~github4.github.GitHub.repository`.

    This object has all the same attributes as
    :class:`~github4.repos.repo.ShortRepository` as well as:
    ...
    .. attribute:: clone_url
        ...
        e.g., ``https://github.com/sigmavirus24/github4.py.git``.
    ...
    .. attribute:: git_url
        ...
        protocol, e.g., ``git://github.com/sigmavirus24/github4.py``.
    ...
    .. attribute:: original_license
        ...
        This is the :class:`~github4.license.ShortLicense` returned as part of
        the repository. To retrieve the most recent license, see the
        :meth:`~github4.repos.repo.Repository.license` method.
    ...
    .. attribute:: parent
        ...
        :class:`~github4.repos.repo.ShortRepository`. If this Repository has
    ...
    .. attribute:: ssh_url
        ...
        protocol, e.g., ``ssh@github.com:sigmavirus24/github4.py.git``.
    ...
    .. attribute:: svn_url
        ...
        e.g., ``ssh@github.com:sigmavirus24/github4.py.git``.
    ...
    def _update_attributes(self, repo):
        ...
        if self.original_license is not None:
            self.original_license = licenses.ShortLicense(self.original_license, self)
...
class ShortRepository(_Repository):
    ...
    :meth:`~github4.github.GitHub.repository`. To provide a clear distinction
    between the types of repositories, github4.py uses different classes with
    ...
    .. attribute:: full_name
        ...
        The full name of this repository, e.g., ``sigmavirus24/github4.py``.
    ...
    .. attribute:: html_url
        ...
        ``https://github.com/sigmavirus24/github4.py``.
    ...
    .. attribute:: name
        ...
        The name of the repository, e.g., ``github4.py``.
    ...
    .. attribute:: owner
        ...
        A :class:`~github4.users.ShortUser` object representing the owner of
        the repository.
...
def repo_issue_params(
    ...
    params.update(issues.issue_params(None, state, labels, sort, direction, since))
    return params

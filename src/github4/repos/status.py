...
class Status(_Status):
    ...
    :class:`~github4.repos.status.ShortStatus` as well as the following
    attributes:

    .. attribute:: creator

        A :class:`~github4.users.ShortUser` representing the user who created
        this status.
    """
...
class ShortStatus(_Status):
    ...
    :class:`~github4.repos.status.CombinedStatus` object.
...
class CombinedStatus(GitHubCore):
    ...
    .. attribute:: statuses
        ...
        The list of :class:`~github4.repos.status.ShortStatus` objects
    ...
    def _update_attributes(self, combined_status):
        ...
        self.repository = repo.ShortRepository(combined_status["repository"], self)

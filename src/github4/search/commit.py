...
class CommitSearchResult(models.GitHubCore):
    ...
    .. attribute:: commit
        ...
        A :class:`~github4.git.ShortCommit` representing the found commit.
    ...
    .. attribute:: repository
        ...
        A :class:`~github4.repos.repo.ShortRepository` representing the
    ...
    .. attribute:: text_matches
        ...
        .. note::
            ...
            :meth:`~github4.github.GitHub.search_commit`.
    """

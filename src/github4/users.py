...
from github4.auths import Authorization
...
class GPGKey(models.GitHubCore):
    ...
    .. attribute:: emails
        ...
        A list of :class:`~github4.users.ShortEmail` attached to this GPG
        key.
    ...
    .. attribute:: subkeys
        ...
        A list of :class:`~github4.users.GPGKey` of the subkeys of this GPG
        key.
    """
...
class _User(models.GitHubCore):
    ...
    def is_assignee_on(self, username, repository):
        ...
        :rtype: :class:`bool`
        """
        url = self._build_url("repos", username, repository, "assignees", self.login)
    ...
    def events(self, public=False, number=-1, etag=None):
        ...
        :param str etag: (optional), ETag from a previous request to the same
            endpoint
        :returns: generator of :class:`Event <github4.events.Event>`\ s
        """
        path = ["events"]
        if public:
            path.append("public")
    ...
    def organizations(self, number=-1, etag=None):
        ...
        :returns: generator of
            :class:`ShortOrganization <github4.orgs.ShortOrganization>`\ s
        """
    ...
    def starred_repositories(self, sort=None, direction=None, number=-1, etag=None):
        ...
        :param str etag: (optional), ETag from a previous request to the same
            endpoint
        :returns: generator of :class:`~github4.repos.repo.StarredRepository`
        """
    ...
    def subscriptions(self, number=-1, etag=None):
        ...
        :param str etag: (optional), ETag from a previous request to the same
            endpoint
        :returns: generator of :class:`Repository <github4.repos.Repository>`
        """
...
class User(_User):
    ...
    :meth:`~github4.github.GitHub.user`. To provide a clear distinction
    between the types of users, github4.py uses different classes with
    different sets of attributes.

    This object no longer contains information about the currently
    authenticated user (e.g., :meth:`~github4.github.GitHub.me`).

    .. versionchanged:: 1.0.0

    This object contains all of the attributes available on
    :class:`~github4.users.ShortUser` as well as the following:
...
class ShortUser(_User):
    ...
    distinction between the types of users, github4.py uses different classes
...
class AuthenticatedUser(User):
    ...
    This is returned by :meth:`~github4.github.GitHub.me`. It contains the
    ...
    :class:`~github4.users.ShortUser` and :class:`~github4.users.User` objects
    as well as:
...
class Collaborator(_User):
    ...
    information as a :class:`~github4.users.ShortUser` with an additional
    attribute:
...
class Contributor(_User):
    ...
    .. versionchanged:: 1.1.0
        ...
        This class now refreshes to a :class:`~github4.users.User`.

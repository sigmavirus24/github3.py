...
class TestRepoCommit(helper.IntegrationHelper):
    ...
    def test_status(self):
        ...
        with self.recorder.use_cassette(cassette_name):
            ...
            commit = repository.commit("9aa43ea48c762b19e8191ae2c5c5fcb87fe30b44")
            combined_status = commit.status()
        assert isinstance(combined_status, github4.repos.status.CombinedStatus)
    ...
    def test_statuses(self):
        ...
        with self.recorder.use_cassette(cassette_name):
            repository = self.gh.repository("sigmavirus24", "github3.py")
            commit = repository.commit("29eaea046b353723f80a4810e3f2ea9d16ea6c25")
    ...
    def test_comments(self):
        ...
        with self.recorder.use_cassette(cassette_name):
            ...
            commit = repository.commit("553c2077f0edc3d5dc5d17262f6aa498e69d6f8e")
    ...
    def test_author_is_not_committer(self):
        ...
        with self.recorder.use_cassette(cassette_name):
            repository = self.gh.repository("sigmavirus24", "github3.py")
            commit = repository.commit("6a0470c992dd97d97fa0fee503153b125141ca4c")
    ...
    def test_associated_pull_requests(self):
        ...
        with self.recorder.use_cassette(cassette_name):
            repository = self.gh.repository("sigmavirus24", "github3.py")
            commit = repository.commit("6b12e37bdc1bea465f04a53262194ab332711ee8")
            for pr in commit.associated_pull_requests():
                assert isinstance(pr, github4.pulls.ShortPullRequest)

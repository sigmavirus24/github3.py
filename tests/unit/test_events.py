...
class TestPayLoadHandlers(TestCase):
    def test_commitcomment(self):
        ...
        assert isinstance(
            comment["comment"], github3.repos.comment.ShortComment
        )
    ...
    def test_issuecomm(self):
        ...
        assert isinstance(
            comment["comment"], github3.events.EventIssueComment
        )
    ...
    def test_pullreqev(self):
        ...
        assert isinstance(
            pull_request["pull_request"], github3.events.EventPullRequest
        )
    ...
    def test_pullreqcomment(self):
        ...
        assert isinstance(
            pull_request["comment"], github3.events.EventReviewComment
        )

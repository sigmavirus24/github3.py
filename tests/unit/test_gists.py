"""Unit tests for the github4.gists module."""
import pytest
...
gist_example_issue_883 = helper.create_example_data_helper("gist_example_issue_883")
gist_example_short_data = helper.create_example_data_helper("gist_example_short")
gist_history_example_data = helper.create_example_data_helper("gist_history_example")
gist_comment_example_data = helper.create_example_data_helper("gist_comment_example")
gist_file_example_data = helper.create_example_data_helper("gist_file_example")
...
class TestGist(helper.UnitHelper):
    ...
    described_class = github4.gists.Gist
    ...
    def test_history(self):
        ...
        assert isinstance(history, github4.gists.history.GistHistory)
    ...
    def test_file(self):
        ...
        assert isinstance(_file, github4.gists.file.GistFile)
...
class TestGistComment(helper.UnitHelper):
    ...
    described_class = github4.gists.comment.GistComment
    example_data = gist_comment_example_data()

    def test_equality(self):
        """Show that two instances of a GistComment are equal."""
        comment = github4.gists.comment.GistComment(
...
class TestGistFile(helper.UnitHelper):
    ...
    described_class = github4.gists.file.GistFile
